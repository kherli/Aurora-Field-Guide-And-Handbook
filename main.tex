...
\renewbibmacro*{repeatedauthor}{%
  \printnames{author}} % Force the printing of the full author name, even if repeated
...
Knowledge of the substorm sequence is useful for aurora chasers. Recognizing the different auroral forms present at each phase of the sequence (i.e., discrete arcs during the growth phase, active aurora during the expansion phase, and patchy, pulsating aurora during the recovery phase) is useful for identifying what may come next. Some phenomena like STEVE (see \ref{steve-sar-arcs}) typically appear during the recovery phase of substorms. These patterns are best appreciated under the quiet auroral oval around 66\textdegree-68\textdegree magnetic latitude. During heightened geomagnetic activity, individual phases of a substorm sequence may be hard to identify.
