...
%\noindent\fbox{%
%    \parbox{\textwidth}{%
%A \textbf{scientist} is a trained expert who is paid and employed at an institution to study the natural world. It is their profession to employ the scientific method to analyse the natural world and publish their results through reputable, peer-reviewed journals.
%}
%}\\
%\\
...
%\noindent\fbox{%
%    \parbox{\textwidth}{%
%{\bf The aurora is the emission of light caused by collisions between energetic charged particles with atoms and molecules in the upper atmosphere, primarily in polar regions. }   }%
%} 
%\newline

\textbf{The aurora is the emission of light caused by collisions between energetic charged particles with atoms and molecules in the upper atmosphere, primarily in polar regions.}
...
\subsection{When to Go Out}\index{aurora chasing!when to go out}\label{sec:whentogoout}
...
\subsection{STEVE \& SAR Arcs}\label{STEVE&SAR}\index{STEVE!discovery}  
...
\subsection{ Fragments}\label{fragments}\index{fragments!discovery} 
%\contributed{Katie}
\begin{figure}
...
\begin{itemize}
    ...
    \item \textbf{Other Helpful Information:} Fragments look a lot like the streaks that are seen at the base of STEVE and the picket fence\index{picket fence} (see \ref{STEVE&SAR})\index{STEVE}. Fragments and streaks occur in different locations with respect to the auroral oval and appear alongside different auroral features. Fragments have been seen alone or close to auroral arcs just poleward of or within the auroral oval, while streaks have mainly been seen with STEVE and the picket fence equatorwards of the auroral oval. 
    \end{itemize}
...
\section{Imaging for Science}\index{contributing!imaging} 
\label{sec: imaging for science}
...
\subsection{Organising Auorora Photos}\index{data!storage}\label{sec:data_cit_storage}
...
\subsubsection{Aurorasaurus}\label{sec:Aurorasaurus}\index{Aurorasaurus}%\todo{Vincent}
...
\label{sec:reciprocity}\index{reciprocity}
...
\subsubsection{Authorship and Acknowledgement}\index{authorship}\label{sec:authorship}
...
\subsubsection{Payment for Data}\label{sec:payment}\index{data!purchasing}
...
\subsubsection{Attribution \& Content Licensing}\index{licensing}\label{sec:licensing}
%\contributed{Rowan}
...
When soliciting photos, observations, survey responses, or any other type of intellectual content from the public, it is recommended as standard to include both a GDPR\index{data!law} statement detailing how any personal data will be stored, alongside a license agreement (see \ref{sec:data_law}).
...
\subsection{Laws and Regulations}\label{sec:data_law}\index{data!law}
